    ...
    <section className="w-full sm:flex justify-around ">
      <div className="flex flex-col pt-28 animation banner_1 sm:px-0 px-5">
        ...
        <div className="mt-8 flex flex-col gap-3">
          <h1 className="animation-text text-white sm:text-5xl font-bold cursor-crosshair text-2xl">
          ...
          <h1 className="animation-text text-white sm:text-5xl font-bold cursor-crosshair text-2xl"><AnimatedLetters letterClass={letterClass} strArray={nameArray} index={15} /></h1>
          <h1 className="animation-text text-white sm:text-5xl font-bold cursor-crosshair text-2xl"><AnimatedLetters letterClass={letterClass} strArray={jobArray} index={33} /></h1>
        </div>
      ...
      <div className="sm:flex items-center pt-10 banner_2 hidden">
