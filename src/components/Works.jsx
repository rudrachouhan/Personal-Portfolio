...
const Works = () => {
  return (
    <section className="projects sm:pl-16 pt-12 pb-16 pl-8 sm:pr-0 pr-8" id="projects">
      ...
      <div className="mt-20 sm:flex flex-wrap sm:flex-row flex-col gap-7 items-center hidden">
        {projects.map((project, index) => (
          <ProjectCard key={`project-${index}`} index={index} {...project} />
        ))}
      </div>

      <div className="mt-20 flex flex-wrap sm:flex-row flex-col gap-7 items-center sm:hidden">
        {projects.map((project, index) => (
